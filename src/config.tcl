...
set ::env(DESIGN_NAME) scan_wrapper_341542971476279892
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341542971476279892.v \
$::env(DESIGN_DIR)/scan_wrapper_341542971476279892.v"
